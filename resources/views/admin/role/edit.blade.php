            ...
            <div class="col-md-12">
              <form action="{{ route('roles.update', ['id' => $role->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text"
                    class="form-control" name="name" placeholder="Nhập tên vai trò" value="{{ $role->name }}">
                </div>
                <div class="form-group">
                  <label >Mô tả vai trò</label>
                  <textarea class="form-control" name="display_name" placeholder="Nhập mô tả" rows="4" >{{ $role->display_name }}
                  </textarea>
                </div>
                  ...
                  <div class="card text-white bg-light  mb-3" style="">
                    ...
                    <div class="card-header bg-success">
                      <div class="form-check col-md-3">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-parent" name="" id="" value="checkedValue" >
                          {{ $permission->name }}
                        </label>
                      </div>
                    </div>
